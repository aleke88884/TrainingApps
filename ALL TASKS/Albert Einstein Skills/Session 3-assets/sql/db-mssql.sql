...
CREATE TABLE [Events] ([Id] [char](36) NOT NULL, [OrganizerId] [char](36) NULL, [LocationId] [char](36) NULL, [EventGroupId] [char](36) NULL, [Name] [varchar](255) NOT NULL, [Description] [text] NULL, [StartsAt] [datetime] NOT NULL, [Duration] [time](7) NULL, [BaseDemand] [decimal](10, 2) NULL, [Cost] [decimal](10, 2) NULL, [Hosts] [varchar](2000) NULL, PRIMARY KEY ([Id]));
